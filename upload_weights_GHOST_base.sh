...
# 本地目录（请更改成你自己的目录）
LOCAL_DIR="/mnt/afs/250010074/robot_manipulation/ROS2_AC-one_Play/policy/GHOST/data/outputs/18.12.59_ghost_policy_pick_place_d405_hard_pointnet/checkpoints/latest.ckpt"
# 网盘目录（请更改成你自己的目录）
